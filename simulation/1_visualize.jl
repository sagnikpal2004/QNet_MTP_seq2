...
success_prob = 0.5 * η_c^2 * exp(-l0 / l_att)  # Entanglement generation probability
ξ = 0.25ϵ_g         # Measurement error rate
F = 1 - 1.25ϵ_g     # Initial bellpair fidelity

t_comm = l0 / c     # internode communication time
t_workload = 1.0    # workload time
# λ = 5               # Average rate of requests per second 
